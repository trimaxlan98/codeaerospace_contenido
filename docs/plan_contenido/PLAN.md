...
| 31 | ESP32: el chip por dentro (**VERTICAL**, 14 clips + intro y cierre) | original (divulgacion de hardware embebido: del silicio a lo que el chip hace con el mundo) | `lienzo.py` (estilo nuevo) + `esp32.py` | **en produccion**: cuarto curso en 9:16 y **primero con el estilo LIENZO** — superficie lisa azul marino, una cosa y un dato por fotograma, cuatro carriles con un solo ocupante cada uno, sin subtitulos y sin HUD. Plan en `curso-31-esp32-vertical.md` |
