...
| 36 | La tesis 6G por dentro (familia, 12 lecciones) + 19 piezas limpias para PowerPoint | original: la tesis doctoral del dueño (gobernanza autonoma de redes programables, NTN 6G, IPN), explorada a fondo | `tesis6g.py` (sonda de **120 invariantes**; numerica del margen adaptativo, mecanica de NTNEnv-v2 reproducida, datos de la tesis LEIDOS de un directorio gitignored) | **en curso** (PR #87): 19 piezas x 2 fondos entregadas en `exports/presentaciones/tesis-6g/` (sin titulos, Carlito, paleta del deck); 48 clips escritos y revisados en ql, CONSOLA sin subtitulos. Plan en `curso-36-tesis-6g.md` |
