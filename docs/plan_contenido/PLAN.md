...
| 33 | Señales y sistemas (**VERTICAL**, 18 piezas + intro y cierre) | original (ocupa la capa de los SISTEMAS: que le hace un sistema a una señal; cita las transformadas del 32 sin volver a explicarlas) | `sistemas.py` (sonda de **73 invariantes**) | **entregado 2026-09-03** (PR #72): sexto curso en 9:16, tercero con estilo LIENZO y segundo MUDO. 20 piezas, 10.82 min en 1080x1920@60, costuras 0.0000/255, sin pista de audio. Nueve de las dieciocho piezas volvieron corregidas y SIETE fallaban igual: una cifra que hablaba del CUADRO y no del sistema. Plan en `curso-33-senales-y-sistemas.md` |
| 34 | Funciones con nombre propio (**VERTICAL**, 18 funciones + intro y cierre) | original (una funcion por pieza, cada una contada por el problema que la obligo a existir) | `especiales.py` (sonda de **177 invariantes**; gamma, Lambert, la eliptica, Fresnel, Bessel, Airy, Legendre, Weierstrass, Cantor, Lorenz, la cicloide, zeta y la superformula implementadas a mano, sin scipy) | **entregado 2026-09-12**: septimo curso en 9:16, cuarto con estilo LIENZO y **primero NARRADO desde el principio** con el ritmo del curso mudo. 20 piezas, 9.94 min en 1080x1920@60, costuras 0.0000/255, pico -1.8 dB, 98 frases de voz sin un solo solape a la primera. Ocupa la capa de LA FUNCION COMO PERSONAJE: no re-explica el caos del 12, ni la dimension del 26, ni las transformadas del 32. Plan en `curso-34-funciones-nombre-propio.md` |
| 35 | Calculo visible (**VERTICAL**, 18 demostraciones + intro y cierre) | original (una idea del calculo de UNA variable por pieza, contada por el dibujo que la demuestra) | `calculo.py` (sonda de **231 invariantes**; secante, epsilon-delta, linealidad local, subtangente de e^x, valor medio, Newton, optimizacion, Riemann, teorema fundamental, hiperbola, longitud de arco, campana, Cavalieri, cebolla, anillo de servilleta, Gabriel, Taylor y armonica, sobre el sustrato de dibujo de `especiales.py`) | **entregado 2026-09-12**: octavo curso en 9:16, quinto con estilo LIENZO y segundo NARRADO desde el principio. 20 piezas en 1080x1920@60. Ocupa la capa de LA DEMOSTRACION QUE SE MIRA: no re-explica los campos del 21, ni la dimension del 26, ni las transformadas del 32, ni las funciones especiales del 34. Plan en `curso-35-calculo-visible.md` |
| 36 | La tesis 6G por dentro (familia, 12 lecciones) + 19 piezas limpias para PowerPoint | original: la tesis doctoral del dueño (gobernanza autonoma de redes programables, NTN 6G, IPN), explorada a fondo | `tesis6g.py` (sonda de **120 invariantes**; numerica del margen adaptativo, mecanica de NTNEnv-v2 reproducida, datos de la tesis LEIDOS de un directorio gitignored) | **PUBLICADO** (PR #87/#88, 2026-09-23): 12 lecciones en prod con sus 48 qh adoptados, narradas (edge) y muxeadas (27.7 min, `exports/tesis6g-*/curso_narrado.mp4`); 19 piezas x 2 fondos entregadas en `exports/presentaciones/tesis-6g/` (sin titulos, Carlito, paleta del deck); 48 clips escritos y revisados en ql, CONSOLA sin subtitulos. Plan en `curso-36-tesis-6g.md` |
| 37 | Rendimiento de SQL Server (familia, 21 lecciones) | el material de un curso presencial del dueño (repo `optimiza-sql`), reescrito para publico general de YouTube | `sqlperf.py` (reproduccion numpy de la base de ejemplo + modelos de lecturas; sonda `sonda_sqlperf.py`) | **producido 2026-09-25**: 21 lecciones / 84 clips, horizontal CONSOLA narrado sin subtitulos y **sin la etiqueta «Modulo 0N»**; montajes con voz edge en `exports/rendimiento-sql-*/curso_narrado.mp4`. Clips escritos por agentes Sonnet con revision de fotogramas del orquestador. PRs #90 y siguiente. Plan en `curso-37-rendimiento-sql.md` |
| 38 | Radio definida por software (familia, 24 lecciones) | original: el curso completo que el curso 8 (8 clips) dejaba corto; enfoque radio real + senales reales, para YouTube | `sdr.py` (sonda de **130 invariantes**; oraculos: scipy, un mensaje ADS-B real KLM1023, tabla ICD de codigos C/A, Viterbi k=7 propio) | **producido 2026-09-25** (PRs #94, #95 y el de cierre): 24 lecciones / 96 clips, horizontal CONSOLA narrado sin subtitulos y sin «Modulo 0N»; voz edge local; **24 montajes en `exports/sdr-*/curso_narrado.mp4` = 57.4 min**, picos <= -1.3 dB, marca -6.0 dB. Del receptor por dentro a FM+RDS, sincronia, ADS-B/AIS/LoRa, Doppler, Meteor LRPT (NOAA APT se apago en 2025), GPS, transmision y DOA. NO subido al VPS (a decision del dueño). Plan en `curso-38-sdr.md` |
