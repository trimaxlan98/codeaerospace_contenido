...
| R4 | Rigor de investigación | `figura.py` (estilo paper, proveniencia, PNG a 300 dpi), `ntn.py` para la tesis (pase LEO, Doppler, handover, PBFT, MA), dos sondas y cinco demos | **librerías hechas** (los datos adjuntos por proyecto siguen en R3) |
