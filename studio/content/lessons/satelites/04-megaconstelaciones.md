...
- **GEO (35 786 km de altitud)**: distancia fija de la estación terrena al satélite. Latencia de un salto de ida: **~119 ms** ($35\,786\,000\ \text{m} / 3\times10^8\ \text{m/s} \approx 0.119\ \text{s}$). Un enlace típico de ida y vuelta a través de un solo satélite GEO (usuario-satélite-hub-satélite-usuario, si el hub también está en tierra) puede alcanzar un **RTT teórico mínimo de $\sim$250 ms**, y en la práctica bordea o supera los 500-600 ms si se cuenta el enrutamiento terrestre adicional.
