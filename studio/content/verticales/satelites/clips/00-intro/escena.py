class Clip(Scene):
    ...
    columna, con el remate propio de este curso: el titulo SATELITES.
    ...
    def construct(self):
        ...
        titulo_curso = titulo("SATELITES", font_size=58)
        titulo_curso.move_to(DOWN * 1.35)
        bajada = Text("la maquina que no se cae", weight="MEDIUM",
