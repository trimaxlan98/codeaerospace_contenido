# =====================================================================
# CO.DE Academy - "Apuntar a un satelite: el arte del seguimiento"
...
from satelites import imagen_mapa, puntos_en_mapa, traza_terrestre
...
import apuntado as _apuntado  # noqa: E402  (tras definir la sombra)
from apuntado import (aguja_velocidad, antena, cono_keyhole,  # noqa: E402
...
# --- Paleta del curso -------------------------------------------------
# Regla: el SATELITE es ambar, la ANTENA cian, el CIELO violeta, lo que
# FALLA rojo, lo LOGRADO verde. No mezclar roles.
C_TITULO = CODE_INK          # #e8edf3 titulos
C_TENUE = CODE_MUTED         # #94a0b0 pies y elementos secundarios
C_ACENTO = CODE_ACCENT       # #f59e0b ambar (alias de C_SAT)
C_ACENTO_2 = CODE_ACCENT_2   # #ea580c naranja de cierre
C_SAT = "#f59e0b"            # ambar: el satelite, su traza, su señal
C_ANTENA = "#22d3ee"         # cian: la antena/estacion
C_CIELO = "#a78bfa"          # violeta: cielo, vista polar, referencias
C_PELIGRO = "#f43f5e"        # rojo: keyhole, error, saturacion
C_OK = "#34d399"             # verde: enganche, ventana util
