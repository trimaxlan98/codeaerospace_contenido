# =====================================================================
# CO.DE Academy - "Electromagnetismo · 1.1 La carga y el campo
# eléctrico". Bloque de estilo del proyecto. Se antepone al script de
...
# discrepar.
Q_PAREJA = 1.0e-6                        # dos cargas de 1 uC
F_1M = coulomb(Q_PAREJA, Q_PAREJA, 1.0)  # 9.0e-3 N a un metro
F_2M = coulomb(Q_PAREJA, Q_PAREJA, 2.0)  # y un cuarto de eso a dos
E_1M = campo_puntual(Q_PAREJA, 1.0)      # 8988 V/m a un metro de 1 uC
# El dipolo contra la carga: a 3 m el monopolo conserva el 11 % de su
# campo a 1 m; el dipolo, solo el 3.7 % — el cubo pierde siempre.
CAIDA_MONO_3M = campo_puntual(1.0, 3.0) / campo_puntual(1.0, 1.0)
CAIDA_DIPO_3M = campo_dipolo_eje(1.0, 3.0) / campo_dipolo_eje(1.0, 1.0)
