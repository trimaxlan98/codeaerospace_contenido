# =====================================================================
# CO.DE Academy - "SDR · 5.1 La constelacion que gira".
...
DF_RS = 0.0037                                    # ciclos por simbolo (param)
SIM, RX = S.escenario_giro(df_rs=DF_RS)            # QPSK, SNR 15 dB
DF_EST = S.estimar_desfase_x4(RX)                  # 0.0037 -> 1.332 grados/simb
GRADOS = 360 * DF_RS                               # 1.33 (param)
GRADOS_EST = 360 * DF_EST                          # 1.332 (medido)
_k = np.arange(len(RX))
RX_CORR = RX * np.exp(-2j * np.pi * DF_EST * _k)   # tras corregir
