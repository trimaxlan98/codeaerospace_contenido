...
from aerodinamica import (GAMMA, R_AIRE, REGIMENES,  # noqa: E402
                          ...
                          curva_compresibilidad, error_incompresible,
                          frentes_moviles, isa, mach_de_error,
                          razon_densidad, razon_energias, velocidad_sonido,
                          zona_de)
...
# La flota del clip 4: (nombre, Mach de operacion, silueta, altitud m).
