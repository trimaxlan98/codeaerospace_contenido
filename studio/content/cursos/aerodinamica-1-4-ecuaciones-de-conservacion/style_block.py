# =====================================================================
# CO.DE Academy - "Aerodinámica · 1.4 Ecuaciones de conservación".
...
M_ENTRADA, M_SALIDA = 0.30, 2.50   # estaciones del conducto del clip 3
AREA_GARGANTA = 0.42               # area minima relativa del De Laval
T0_EJEMPLO = 300.0                 # temperatura de estancamiento, K
T_SALIDA = T0_EJEMPLO / float(razon_temperatura(M_SALIDA))   # 133.3 K
V_SALIDA = M_SALIDA * float(velocidad_sonido(T_SALIDA))      # 579 m/s
