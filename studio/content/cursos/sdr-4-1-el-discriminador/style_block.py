# =====================================================================
# CO.DE Academy - "SDR · 4.1 El discriminador".
...
FS = S.FS_MPX                                     # 228 kHz
DESV = S.DESV_FM                                   # 75 kHz (dato)
CARSON_MONO = S.carson(DESV, 15e3)                 # 180 kHz
CARSON_EST = S.carson(DESV, 53e3)                  # 256 kHz
_t = np.arange(1 << 15) / FS
X15 = S.fm_modular(np.sin(2 * np.pi * 15e3 * _t), FS)
OCUPADO = S.ancho_ocupado(X15, FS)                 # 180.0 kHz medido al 98 %
MEJORA_DE = S.mejora_deenfasis()                   # 12.2 dB
