# =====================================================================
# CO.DE Academy - "Aerodinámica · 2.4 Flujo cuasi-unidimensional en conductos".
...
AREA_SALIDA = 1.0 / AREA_GARGANTA    # 2.381 — la relacion de areas del tubo
M_SALIDA_SUPER = mach_de_area(AREA_SALIDA, "super")   # 2.39
M_SALIDA_SUB = mach_de_area(AREA_SALIDA, "sub")       # 0.25
AREA_EJEMPLO = 1.6875                # la fila de M = 2 de la tabla de la 1.5
M_EJEMPLO_SUB = mach_de_area(AREA_EJEMPLO, "sub")     # 0.372
M_EJEMPLO_SUPER = mach_de_area(AREA_EJEMPLO, "super")  # 2.00
