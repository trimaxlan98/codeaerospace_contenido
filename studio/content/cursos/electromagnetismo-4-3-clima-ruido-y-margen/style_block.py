# =====================================================================
# CO.DE Academy - "Electromagnetismo · 4.3 El clima, el ruido y el
# margen". Bloque de estilo del proyecto. Se antepone al script de CADA
# clip; los clips NO repiten imports: solo definen su ClipN(Scene).
#
...
# discrepar.
R_CHAPARRON = 25.0                       # lluvia fuerte, 25 mm/h
F_KU = 12.0                              # GHz: Ku bajo, la TV directa
F_KA_BAJA = 20.0                         # GHz: bajada Ka
F_KA_ALTA = 30.0                         # GHz: subida Ka
# ITU-R P.838-3: la misma tormenta cobra cinco veces mas arriba.
AT_KU = atenuacion_lluvia(F_KU, R_CHAPARRON)         # 1.1 dB/km
AT_KA_BAJA = atenuacion_lluvia(F_KA_BAJA, R_CHAPARRON)   # 2.8 dB/km
AT_KA_ALTA = atenuacion_lluvia(F_KA_ALTA, R_CHAPARRON)   # 5.1 dB/km
LAM_KA_MM = lambda_de(F_KA_ALTA * 1e9) * 1000.0      # 10 mm de onda
# El suelo de ruido contra el que se mide todo enlace.
T_SISTEMA = 150.0                        # K de un receptor de estacion
B_TRANSPONDEDOR = 36.0e6                 # Hz del transpondedor clasico
N_DBW = ruido_dbw(T_SISTEMA, B_TRANSPONDEDOR)        # -131.3 dBW
T_CIELO = 20.0                           # K que ve la antena al cenit
T_SUELO = 290.0                          # K del planeta tibio
