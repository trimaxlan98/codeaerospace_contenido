# =====================================================================
# CO.DE Academy - "Electromagnetismo · 2.2 Las ecuaciones de
# Maxwell". Bloque de estilo del proyecto. Se antepone al script de
...
# discrepar.
# La sorpresa de Maxwell: 1/sqrt(mu0 eps0) sale de dos constantes de
# mesa de laboratorio (bobinas y condensadores, ninguna luz) y coincide
# con la velocidad de la luz medida. C_LUZ, MU0 y EPS0 vienen de la
# libreria; aqui solo se hace la cuenta del clip 4.
C_MAXWELL = c_de_constantes()            # 1/sqrt(mu0 eps0) = 299 792 458 m/s
# Notacion cientifica para rotular MU0 y EPS0 sin literales: mantisa y
# exponente CALCULADOS del propio numero.
EXP_MU0 = math.floor(math.log10(MU0))    # -6
MANT_MU0 = MU0 / 10.0 ** EXP_MU0         # 1.2566
EXP_EPS0 = math.floor(math.log10(EPS0))  # -12
MANT_EPS0 = EPS0 / 10.0 ** EXP_EPS0      # 8.8542
