# =====================================================================
# CO.DE Academy - "SDR · 1.2 Mezclar es multiplicar".
...
F_SENAL = S.F_SENAL                                # 100.3 MHz (elegida)
F_LO = S.F_LO                                      # 89.6 MHz
F_IF = S.F_IF                                      # 10.7 MHz (dato: FI de FM)
F_IMG = S.imagen_real()[1]                         # 78.9 MHz
_ESP_F, _ESP_DB, (F_SUMA, F_DIF) = S.mezclar_real()  # 189.9 / 10.7 MHz
MEZ_REAL = S.mezcla_imagen(complejo=False)         # dB en (+FI, -FI)
MEZ_CPLX = S.mezcla_imagen(complejo=True)
CENTRO = 96.4e6                                    # captura del 1.1
FS = S.RTL["fs"]
