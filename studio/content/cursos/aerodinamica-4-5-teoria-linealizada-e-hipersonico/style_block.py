# =====================================================================
# CO.DE Academy - "Aerodinámica · 4.5 Teoría supersónica linealizada y panorama hipersónico".
...
from aerodinamica import (COMPRESION_MAXIMA, GAMMA,  # noqa: E402
                          KORN_CONVENCIONAL, KORN_SUPERCRITICO, NU_MAXIMO,
                          REGIMENES, REGIMENES_TOBERA, R_AIRE, abanico_expansion,
                          ackeret, ala_flecha, angulo_mach, balanza_energias,
                          banda_regimenes, barras_calores, barras_entalpia,
                          choque_normal, choque_oblicuo, comparacion_teorias,
                          conducto, cp_critico, criticas, curva_anemometro,
                          curva_area_mach, curva_arrastre_transonico,
                          curva_mach_critico, curva_mu, curva_nu,
                          curva_sonido, curva_compresibilidad, curvas_choque,
                          curvas_correcciones, curvas_isentropicas,
                          diagrama_theta_beta, diagrama_ts, diagrama_xt,
                          distribucion_area, error_anemometro,
                          ...
                          karman_tsien, laitone, mach_critico, mach_de_area,
                          mach_de_error, mach_de_nu, mach_divergencia,
                          mach_normal_flecha, onda_oblicua, perfil_choque,
                          perfil_isa, perfil_rombico, perfil_supersonico,
                          perfil_tobera, perfiles_transonicos, piston_gas,
                          placa_plana, prandtl_glauert, prandtl_meyer,
...
M_LINEAL = 2.0                       # el caso de siempre del modulo 3
ALFA_LINEAL = 10.0                   # angulo de ataque, en grados
SEMIANGULO = 5.0                     # semiangulo del rombo
PLACA_ACK = ackeret(M_LINEAL, ALFA_LINEAL)
PLACA_EXA = placa_plana(M_LINEAL, ALFA_LINEAL)
ROMBO_ACK = ackeret(M_LINEAL, ALFA_LINEAL, semiangulo=SEMIANGULO)
ROMBO_EXA = perfil_rombico(M_LINEAL, ALFA_LINEAL, SEMIANGULO)
M_HIPER = 10.0                       # el panorama del clip 4
T_HIPER = isa(11000.0)[0]            # 216.65 K ahi fuera
T0_HIPER = T_HIPER * float(razon_temperatura(M_HIPER))   # 4550 K en el morro
