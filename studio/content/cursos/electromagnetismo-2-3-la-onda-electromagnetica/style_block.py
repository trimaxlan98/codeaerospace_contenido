# =====================================================================
# CO.DE Academy - "Electromagnetismo · 2.3 La onda electromagnética".
...
# discrepar.
F_FM = 100e6                             # la radio FM del coche
F_GPS = 1.57542e9                        # GPS L1
F_KU = 12e9                              # la TV directa al plato
F_KA = 30e9                              # la banda ancha satelital
LAMBDA_KU = lambda_de(F_KU)              # 25 mm: cabe en un balcon
ETA0 = impedancia_vacio()                # 376.73 ohm: la razon E/H
S_SOL = 1361.0                           # W/m2: la constante solar
E_SOL = campo_de_flujo(S_SOL)            # 1013 V/m de pico en la luz
