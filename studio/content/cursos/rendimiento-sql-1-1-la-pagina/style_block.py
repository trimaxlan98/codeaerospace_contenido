# =====================================================================
# CO.DE Academy - "Rendimiento SQL · 1.1 La pagina: lo que cuesta leer".
# Bloque de estilo del proyecto: se antepone al script de CADA clip; los
# clips NO repiten imports, solo definen su ClipN(Scene).
#
# MOLDE de la familia "Rendimiento SQL" (curso 37, 21 lecciones). Entre
...
FILAS_DET = S.detalle_total()                                   # 3,750,000
...
PAG_POR_FILA = M["scan_pedidos"] / C501                         # 117
