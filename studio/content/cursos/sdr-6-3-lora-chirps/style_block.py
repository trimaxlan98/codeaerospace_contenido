# =====================================================================
# CO.DE Academy - "SDR · 6.3 LoRa: chirps".
...
BW = 125e3                                        # (dato)
UMBRAL = {sf: S.umbral_lora(sf, n_sim=200) for sf in (7, 9, 12)}  # -8.5/-14.5/-23.0
T_SIMB = {sf: S.tiempo_simbolo_ms(sf) for sf in (7, 9, 12)}      # 1.02/4.10/32.8 ms
