# =====================================================================
# CO.DE Academy - "Agentes de IA: maquinas que operan el mundo"
...
import agentes as _agentes  # noqa: E402  (tras definir la sombra)
from agentes import (burbuja, catalogo_herramientas,  # noqa: E402
                     escala_autonomia, escudo, girar_lazo, lazo_agente,
...
# --- Paleta del curso -------------------------------------------------
# Regla: el AGENTE es cian, el MUNDO violeta, la ACCION ambar, lo
# PERMITIDO verde, lo PELIGROSO rojo. No mezclar roles.
C_TITULO = CODE_INK          # #e8edf3 titulos
C_TENUE = CODE_MUTED         # #94a0b0 pies y elementos secundarios
C_ACENTO = CODE_ACCENT       # #f59e0b ambar: acciones, llamadas, lazo
C_ACENTO_2 = CODE_ACCENT_2   # #ea580c naranja de cierre
C_AGENTE = "#22d3ee"         # cian: el agente y sus pensamientos
C_MUNDO = "#a78bfa"          # violeta: mundo, datos, observaciones
C_OK = "#34d399"             # verde: valido, permitido
C_PELIGRO = "#f43f5e"        # rojo: error, inyeccion, bloqueado
