# =====================================================================
# CO.DE Academy - "SDR · 5.3 El reloj de simbolo".
...
TAUS = np.array([0.0, 0.1, 0.2, 0.3, 0.4])         # fraccion de simbolo
BER = S.ber_vs_desfase(TAUS)                       # 0.11 % ... 4.8 % (7 dB)
TT = np.linspace(-0.5, 0.5, 21)
CURVA_S = S.gardner_curva_s(TT)
TAU_L, YS, SM = S.lazo_reloj()                     # 0.37 -> ~0
EVM0 = S.evm_pct(YS[1:60], SM[1:60])               # 35.4 %
EVM1 = S.evm_pct(YS[-300:], SM[-300:])             # 6.4 %
