# =====================================================================
# CO.DE Academy - "SDR · 4.2 El multiplex estereo".
...
FS = S.FS_MPX
Y_MPX, L_TX, R_TX = S.mpx()                        # L 1 kHz, R 3 kHz (param)
FASE_P, ERR_P = S.pll_piloto(Y_MPX)
L_RX, R_RX = S.separar_lr(Y_MPX, FASE_P)
SEPARACION = S.separacion_db(L_RX, R_RX)           # 59.3 dB
L5, R5 = S.separar_lr(Y_MPX, FASE_P + np.radians(5))
SEPARACION_5 = S.separacion_db(L5, R5)             # 48.4 dB
PRECIO = S.precio_estereo()                        # 15.4 dB
