# =====================================================================
# CO.DE Academy - "Electromagnetismo · 2.1 La inducción de Faraday".
...
# discrepar.
N_ALTERNADOR = 100                       # vueltas de la espira giratoria
B_ALTERNADOR = 0.1                       # T entre los polos
AREA_ALTERNADOR = 0.01                   # m^2 (100 cm^2)
HZ_ALTERNADOR = 50.0                     # Hz de la red
OMEGA_ALTERNADOR = 2.0 * math.pi * HZ_ALTERNADOR
FEM_PICO = fem_espira(N_ALTERNADOR, B_ALTERNADOR, AREA_ALTERNADOR,
                      OMEGA_ALTERNADOR)  # pico N B A omega -> 31.4 V

N1_TRAFO = 4                             # espiras del primario (dibujadas)
N2_TRAFO = 8                             # espiras del secundario (dibujadas)
RELACION_TRAFO = N2_TRAFO / N1_TRAFO     # V2/V1 = N2/N1 -> 2.0
