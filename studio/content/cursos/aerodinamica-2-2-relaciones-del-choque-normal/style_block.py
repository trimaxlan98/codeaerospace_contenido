# =====================================================================
# CO.DE Academy - "Aerodinámica · 2.2 Relaciones de la onda de choque normal".
...
M1_REF = 2.0                         # el choque que se resuelve en clase
SALTO = choque_normal(M1_REF)        # M2, p2/p1, T2/T1, rho2/rho1, p02/p01
M_MAX_CURVAS = 3.0                   # hasta donde llegan las graficas
TOPE_COMPRESION = COMPRESION_MAXIMA  # 6.0: por mucho M1, la densidad no sube mas
