# =====================================================================
# CO.DE Academy - "Electromagnetismo · 1.3 La fuerza de Lorentz".
# Bloque de estilo del proyecto. Se antepone al script de CADA clip;
# los clips NO repiten imports: solo definen su ClipN(Scene).
#
# Copia del MOLDE de la familia "Electromagnetismo" (leccion 1.1): solo
# cambian esta cabecera y la tabla de numeros de la leccion. Por eso la
# paleta, los rotulos y los helpers viven aqui y no en un clip.
# =====================================================================
import math
import sys
...
# discrepar.
V_ELECTRON = 1.0e7                       # el electron del clip 1, en m/s
B_SUPERFICIE = 50e-6                     # los 50 uT del campo terrestre
# El giro de Larmor con esos numeros: 1.14 m de radio a 1.40 MHz. Son
# los MISMOS argumentos por defecto de giro_larmor(), asi el circulo
# dibujado y la cifra rotulada no pueden discrepar.
R_LARMOR = radio_larmor(Q_E, M_ELECTRON, V_ELECTRON, B_SUPERFICIE)
F_GIRO = frecuencia_giro(Q_E, M_ELECTRON, B_SUPERFICIE)
# Las tres alturas de trabajo del clip 3 (las mismas que dibuja
# mapa_orbitas por defecto): LEO pasa POR DEBAJO de los cinturones,
# GPS vive DENTRO del exterior y GEO queda en su borde de fuera.
H_LEO = 550e3
H_GPS = 20200e3
H_GEO = 35786e3
