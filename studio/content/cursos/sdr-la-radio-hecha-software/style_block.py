# =====================================================================
# CO.DE Academy - "SDR: la radio hecha software"
...
import radio as _radio  # noqa: E402  (tras definir la sombra)
from radio import (barras_espectro, constelacion_bpsk,  # noqa: E402
                   curva_acantilado, diagrama_ojo, fasor,
                   flujo_en_bloques, girar_fasor, onda_am, onda_fm,
                   onda_senoidal, pico_espectral, plano_iq,
...
# --- Paleta del curso -------------------------------------------------
# Regla: la SEÑAL es ambar, I cian, Q violeta, el RUIDO y sus fantasmas
# rojos, lo RECUPERADO verde. No mezclar roles.
C_TITULO = CODE_INK          # #e8edf3 titulos
C_TENUE = CODE_MUTED         # #94a0b0 pies y elementos secundarios
C_ACENTO = CODE_ACCENT       # #f59e0b ambar (alias de C_SENAL)
C_ACENTO_2 = CODE_ACCENT_2   # #ea580c naranja de cierre
C_SENAL = "#f59e0b"          # ambar: la señal, picos, trazas, fasor
C_I = "#22d3ee"              # cian: componente I, envolvente, el "uno"
C_Q = "#a78bfa"              # violeta: componente Q, FM, el "cero"
