# =====================================================================
# CO.DE Academy - "SDR · 2.3 Senales que saturan".
...
F1, F2 = S.F_IM1, S.F_IM2                          # 98.1 / 98.5 MHz (datos)
F_IM_BAJO = 2 * F1 - F2                            # 97.7 MHz
F_IM_ALTO = 2 * F2 - F1                            # 98.9 MHz
RIP3 = S.recta_ip3()                               # barrido medido
PEND1, PEND3 = RIP3["pendiente_1"], RIP3["pendiente_3"]    # 1.00 / 3.00
IIP3 = RIP3["iip3_db"]                             # 11.2 dB (teorico 11.25)
G_LIN = S.ganancia_debil(0.0)                      # 20.0 dB
DESENS = S.ganancia_debil(S.AMP_BLOQUEADOR) - G_LIN    # -11.2 dB
TRAS_FILTRO = S.ganancia_debil(
    S.AMP_BLOQUEADOR * 10 ** (-S.ATEN_FILTRO_DB / 20)) - G_LIN   # 0.0 dB
F_SAT = 137.1e6                                    # el satelite debil
