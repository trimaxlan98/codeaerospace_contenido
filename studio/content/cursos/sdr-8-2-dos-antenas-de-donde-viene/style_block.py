# =====================================================================
# CO.DE Academy - "SDR · 8.2 Dos antenas: de donde viene".
...
THETA = 25.0                                       # angulo real (param)
ANG_05, DPHI_05 = S.doa_estimar(THETA, 0.5)        # [25.0], rad
ANG_1, DPHI_1 = S.doa_estimar(THETA, 1.0)          # [-35.2, 25.0]
