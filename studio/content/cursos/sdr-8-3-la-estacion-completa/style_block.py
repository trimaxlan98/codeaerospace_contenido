# =====================================================================
# CO.DE Academy - "SDR · 8.3 La estacion completa".
...
PRES = S.presupuesto()                             # dict: alcance, fspl, prx...
P = S.PRESUPUESTO                                  # insumos (todos parametros)
T_P, DOP, TASA = S.doppler_pase(P["f_hz"], h_km=P["h_km"])
MET = S.cadena_meteor()
IMG_RX = MET["img_rx"]
NF_ANT = S.friis([S.LNA, S.CABLE, S.RECEPTOR])     # 1.04 (del 2.1)
