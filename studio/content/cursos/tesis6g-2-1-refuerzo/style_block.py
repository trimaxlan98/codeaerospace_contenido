# =====================================================================
# CO.DE Academy - "Tesis 6G · 2.1 Aprender por refuerzo". Bloque de estilo
...
_Y = _yaml.safe_load((T6.DATOS_DIR / "entorno_v2.yaml").read_text())
ALFA, BETA, GAMMA = (_Y["rewards"][k] for k in ("alpha", "beta", "gamma"))
# un paso de ejemplo con la formula de la tesis: r = a*tp + b*lat - g*intf
EJ_TP, EJ_LAT, EJ_INTF = 80.0, 12.0, 0.10
EJ_R = ALFA * EJ_TP + BETA * EJ_LAT - GAMMA * EJ_INTF
QJ = T6.q_juguete(pasos=600, alfa=0.1, eps=0.2, semilla=42)
QJ0 = T6.q_juguete(pasos=600, alfa=0.1, eps=0.0, semilla=42)   # sin explorar
CURVA = T6.curva_entrenamiento(42)
EPS_K = T6.pasos_hasta_eps(CURVA["eps_min"], CURVA["eps_decay"])
G42 = D["g2b"][0]
ACC = ["bajo", "alto", "ruta"]
