# =====================================================================
# CO.DE Academy - "SDR · 3.3 El reloj que miente".
...
PPM_BARATO, PPM_TCXO = 25.0, 1.0                # cristal barato / TCXO (datos)
FRECS = (100e6, 437e6, 1090e6)
ERR25 = [S.ppm_a_hz(PPM_BARATO, f) for f in FRECS] # 2.5 / 10.9 / 27.3 kHz
ERR1 = [S.ppm_a_hz(PPM_TCXO, f) for f in FRECS]    # 0.1 / 0.44 / 1.09 kHz
F_REF = 144.39e6                                   # portadora conocida (dato)
PPM_REAL = 27.0                                    # el error del aparato (param)
PPM_EST, HZ_EST = S.estimar_ppm(PPM_REAL, F_REF)   # 27.0 ppm, +3898 Hz
WF, T_WF, DERIVA, DERIVA_MED = S.waterfall_deriva()  # 927 / 926 Hz en 10 min
