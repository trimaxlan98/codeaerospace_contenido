# =====================================================================
# CO.DE Academy - "Aerodinámica · 3.3 Reflexión e interacción de ondas".
...
M_TUNEL = 2.4                        # la corriente del tunel del clip 1
THETA_TUNEL = 8.0                    # deflexion de la cuna que genera la onda
REFLEJO = reflexion_onda(tipo="pared", mach1=M_TUNEL, theta=THETA_TUNEL).datos
LIBRE = reflexion_onda(tipo="libre", mach1=M_TUNEL, theta=THETA_TUNEL).datos
M_CRUCE = 3.0                        # el cruce de choques del clip 3
THETA_SUP, THETA_INF = 10.0, 16.0    # dos cunas de fuerza distinta
