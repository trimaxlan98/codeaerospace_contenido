# =====================================================================
# CO.DE Academy - "El espectro: la guerra invisible por las ondas"
...
import espectro as _espectro  # noqa: E402  (tras definir la sombra)
from espectro import (barra_bandas, curva_gases,  # noqa: E402
                      curva_lluvia, gotas_y_onda, haz, linea_tiempo,
                      patron_antena, tierra_y_anillos)
...
# --- Paleta del curso -------------------------------------------------
# Regla: la ONDA/banda es ambar, el GSO cian, el NGSO violeta, la
# PERDIDA/interferencia roja, la VENTANA/solucion verde.
...
C_GSO = "#22d3ee"            # cian: el GSO, lo establecido
C_NGSO = "#a78bfa"           # violeta: constelaciones NGSO, lo nuevo
C_PERDIDA = "#f43f5e"        # rojo: lluvia, absorcion, interferencia
C_OK = "#34d399"             # verde: ventana atmosferica, coexistencia
