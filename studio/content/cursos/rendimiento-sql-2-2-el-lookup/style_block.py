# =====================================================================
# CO.DE Academy - "Rendimiento SQL · 2.2 El viaje de vuelta: lookup".
...
MODELO_501 = S.lecturas_seek_lookup(C501)                       # 576 (motor: 597)
MODELO_1 = S.lecturas_seek_lookup(C1)                           # 449,913 (motor: 450,173)
PUNTO = S.punto_inflexion()                                     # filas=7,454.3 fraccion=0.00497
PUNTO_FILAS = round(PUNTO["filas"])                             # 7,454
PUNTO_PCT = PUNTO["fraccion"] * 100                             # 0.497 -> "0.50 %"
