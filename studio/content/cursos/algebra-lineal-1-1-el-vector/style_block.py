# =====================================================================
# CO.DE Academy - "Álgebra lineal · 1.1 El vector: flecha, lista y
# movimiento". Bloque de estilo del proyecto. Se antepone al script de
...
# discrepar.
V_DEMO = np.array([3.0, 2.0])            # el vector protagonista (3, 2)
U_SUMA = np.array([2.0, 1.0])            # u y v de la suma
V_SUMA = np.array([1.0, 2.0])
SUMA = U_SUMA + V_SUMA                   # (3, 3)
ESCALARES = (2.0, 0.5, -1.5)             # 2u, u/2, -1.5u sobre la misma recta
U_ESC = np.array([2.0, 1.0])
COMPONENTES = (V_DEMO[0], V_DEMO[1])     # 3 i + 2 j
