# =====================================================================
# CO.DE Academy - "Electromagnetismo · 3.3 Las antenas". Bloque de
...
# discrepar.
F_FM = 1.0e8                             # la radio FM: 100 MHz
LARGO_DIPOLO_FM = lambda_de(F_FM) / 2.0  # dipolo de media onda: 1.5 m
D_DIPOLO_MEDIO = directividad(patron_dipolo_medio)  # 1.64, integrada
G_DIPOLO_DBI = db_de(D_DIPOLO_MEDIO)     # 2.15 dBi del dipolo lambda/2
D_PLATO = 0.6                            # el plato de balcon: 60 cm
F_KU_TV = 12.0e9                         # banda Ku de la TV directa
EF_PLATO = 0.6                           # eficiencia tipica de apertura
G_PLATO_DBI = db_de(ganancia_apertura(D_PLATO, F_KU_TV, EF_PLATO))
FASE_ARRAY = 60.0                        # rampa de fase de la demo (deg)
