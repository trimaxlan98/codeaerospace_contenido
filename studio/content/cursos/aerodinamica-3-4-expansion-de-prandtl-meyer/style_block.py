# =====================================================================
# CO.DE Academy - "Aerodinámica · 3.4 Expansión de Prandtl-Meyer".
...
M_ESQUINA = 2.0                      # el flujo que llega a la esquina
THETA_ESQUINA = 15.0                 # cuanto gira la pared, en grados
EXPANDIDO = expansion(M_ESQUINA, THETA_ESQUINA)   # M2 = 2.598
NU_TOPE = NU_MAXIMO                  # 130.45 deg: el giro total maximo
MACHS_NU = (1.5, 2.0, 3.0, 5.0)      # los puntos que se marcan en la curva
