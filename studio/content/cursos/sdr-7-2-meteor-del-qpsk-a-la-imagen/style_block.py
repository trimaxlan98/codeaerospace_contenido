# =====================================================================
# CO.DE Academy - "SDR · 7.2 Meteor: del QPSK a la imagen".
...
ESN0 = 4.0                                         # Es/N0 (param)
MET = S.cadena_meteor(esn0_db=ESN0, rotacion=1)    # dict (imagen sintetica)
BER_CRUDA = MET["ber_cruda"]                       # 5.6 %
ERR_VIT = MET["errores_viterbi"]                   # 0
CORR_ASM = MET["corr_asm"]                         # [0.2, 1.05, -0.2, -1.05]
ROT = MET["rotacion_hallada"]                      # 1 (x 90 grados)
IMG, IMG_RX, IMG_CRUDA = MET["img"], MET["img_rx"], MET["img_cruda"]
