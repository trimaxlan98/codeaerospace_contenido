# =====================================================================
# CO.DE Academy - "Electromagnetismo · 4.1 La ionosfera". Bloque de
# estilo del proyecto. Se antepone al script de CADA clip; los clips
# NO repiten imports: solo definen su ClipN(Scene).
#
...
# discrepar.
NE_PICO_F = 1.0e12                        # Ne pico de la capa F de dia (m-3)
FP_PICO = frecuencia_plasma(NE_PICO_F)    # ~8.98 MHz: el techo de la HF
TEC_GPS = 5.0e17                          # 50 TECU, dia tranquilo
F_L1 = 1.57542e9                          # portadora GPS L1
F_L2 = 1.22760e9                          # portadora GPS L2
RETARDO_L1 = retardo_iono(TEC_GPS, F_L1)  # 8.1 m de camino extra
RETARDO_L2 = retardo_iono(TEC_GPS, F_L2)  # 13.4 m: mas lento, mas peaje
