# =====================================================================
# CO.DE Academy - "Electromagnetismo · 1.2 La corriente y el campo
# magnético". Bloque de estilo del proyecto. Se antepone al script de
...
# discrepar.
I_HILO = 1.0                             # el amperio de Oersted
B_HILO_1M = b_hilo(I_HILO, 1.0)          # 2e-7 T a un metro del hilo
N_SOL = 1000.0                           # espiras por metro del carrete
I_SOL = 10.0                             # y diez amperios dentro
B_SOL = b_solenoide(N_SOL, I_SOL)        # 12.6 mT: campo de laboratorio
B_SUP = b_tierra(1.0)                    # 31.2 uT en el ecuador
# GEO queda a 6.61 radios terrestres; el dipolo cae con el cubo y alli
# apenas sobreviven 0.11 uT — trescientas veces menos que en superficie.
R_GEO_RE = radio_geo() / R_TIERRA
B_GEO = b_tierra(R_GEO_RE)
