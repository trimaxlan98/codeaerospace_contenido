# =====================================================================
# CO.DE Academy - "SDR · 1.1 De la antena al numero".
...
FS = S.RTL["fs"]                                   # 2.4 MS/s (dato)
BITS = S.RTL["bits"]                               # 8 (dato)
CAUDAL = S.caudal_bps() / 1e6                      # 38.4 Mbit/s
AUDIO = S.caudal_audio() / 1e6                     # 0.768 Mbit/s
REDUCCION = S.reduccion()                          # 50
SQNR8 = S.sqnr_adc(8)                              # 49.9 dB
SQNR12 = S.sqnr_adc(12)                            # 74 dB (sin decimales)
CENTRO_A = 90.8e6                                  # primera parada del LO
CENTRO_B = 96.4e6                                  # ventana con mas emisoras
N_A, _ = S.emisoras_en(CENTRO_A)
N_B, F_B = S.emisoras_en(CENTRO_B)                 # 5 emisoras
