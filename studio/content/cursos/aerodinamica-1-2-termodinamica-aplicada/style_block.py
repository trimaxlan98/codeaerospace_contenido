# =====================================================================
# CO.DE Academy - "Aerodinámica · 1.2 Repaso de termodinámica aplicada".
...
R_UNIVERSAL = 8314.46          # constante universal, J/(kmol K)
M_AIRE = 28.9647               # masa molar del aire seco, kg/kmol
R_DEDUCIDA = R_UNIVERSAL / M_AIRE      # 287.0 — la R del aire, no la de todos
CV_AIRE = R_AIRE / (GAMMA - 1)         # 717.6 J/(kg K)
CP_AIRE = GAMMA * R_AIRE / (GAMMA - 1)  # 1004.7 J/(kg K)
COMPRESIONES = (0.50, 0.32)    # fracciones de volumen del embolo, clip 1
T_EJEMPLO = 288.15             # nivel del mar ISA, K
