# =====================================================================
# CO.DE Academy - "SDR · 6.2 AIS: barcos".
...
MSG = S.ais_mensaje1()                            # 168 bits, barco FICTICIO
TRAMA, RELLENO = S.ais_trama(MSG)                  # 233 bits, 1 de relleno
NIVELES = S.nrzi(TRAMA)
X_GMSK = S.gmsk(NIVELES, 8)
AIS, _, _ = S.cadena_ais()                         # dict: mmsi, lat, lon, sog...
