# =====================================================================
# CO.DE Academy - "Aerodinámica · 4.3 Número de Mach crítico y divergencia del arrastre".
...
CP0_GRUESO = -0.60                   # perfil grueso o muy cargado
CP0_DELGADO = -0.35                  # perfil fino o poco cargado
MCR_GRUESO = mach_critico(CP0_GRUESO)     # 0.689
MCR_DELGADO = mach_critico(CP0_DELGADO)   # 0.766
