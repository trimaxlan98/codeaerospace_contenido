# =====================================================================
# CO.DE Academy - "SDR · 4.3 RDS: el texto escondido".
...
FS = S.FS_MPX
PS = "CODE FM "                                    # nombre de la emisora (ficticio)
BITS_PS = S.grupos_ps(PS)                          # 416 bits (4 grupos x 4 bloques)
RDS = S.cadena_rds(PS)                             # dict: ps, errores, hits, bits
RDS8 = S.cadena_rds(PS, cnr_db=8.0, semilla=1)     # 12 bits errados, nombre OK
BLOQUE_A = S.bloque_rds(0xC0DE, "A")
