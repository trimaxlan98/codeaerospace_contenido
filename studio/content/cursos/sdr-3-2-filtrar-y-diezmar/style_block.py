# =====================================================================
# CO.DE Academy - "SDR · 3.2 Filtrar y diezmar".
...
FS = S.RTL["fs"]
N_TAPS = S.kaiser_taps(60.0, 40e3, FS)             # 219
H = S.fir_paso_bajo(N_TAPS, 120e3, FS)
ATEN = S.aten_minima(H, FS, 140e3)                 # 59.3 dB (lobulos)
FUGA_SIN, F_PLEG = S.fuga_vecina(False)            # 0.0 dBc en +20 kHz
FUGA_TECHO = S.fuga_vecina_suelo()[0]              # -60 -> "menos de -60 dBc"
N1, MAC1 = S.coste_una_etapa()                     # 219 coef, 52.6 M MAC/s
A1, A2, MAC2 = S.coste_dos_etapas()                # 39 + 45 coef, 29.5 M MAC/s
